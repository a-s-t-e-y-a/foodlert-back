...
router.patch('/supplier/:id', inventorySupplierController.updateInventorySupplier);
router.delete('/supplier/:id', inventorySupplierController.deleteInventorySupplier);

// cart
router.post('/cart/:id', inventorySupplierCartController.createInventorySupplierCart);
router.get('/cart/:id', inventorySupplierCartController.getAllInventorySupplierCart);
router.patch('/:id/cart/:cartId', inventorySupplierCartController.updateInventorySupplierCart);
router.delete('/:id/cart/:cartId', inventorySupplierCartController.deleteInventorySupplierCart);
...
// stockTake
router.post('/stocktake', inventoryStocktakeController.createInventoryStocktake);
router.get('/stocktake', inventoryStocktakeController.getAllInventoryStocktake);
router.get('/stocktake/:id', inventoryStocktakeController.getInventoryStocktake);
router.patch('/stocktake/:id', inventoryStocktakeController.updateInventoryStocktake);
router.delete('/stocktake/:id', inventoryStocktakeController.deleteInventoryStocktake);
